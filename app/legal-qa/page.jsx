...
export default function LegalQA() {
  ...
  function printAnswer() {
    ...
    printWindow.document.write(`
      ...
      <html>
        <head>
          <title>Legal Q&A — Firm Law AI</title>
          <style>
        ...
        <body>
          ...
          <hr/>
          <div>${answer}</div>
          <div class="footer">This answer was AI-generated by Firm Law AI. This is general legal information only. Please consult a qualified advocate for your specific situation.</div>
