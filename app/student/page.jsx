...
export default function LawStudent() {
  ...
  function printAnswer() {
    ...
    printWindow.document.write(`
      ...
      <html>
        <head>
          <title>${selectedMode.title} — Firm Law AI</title>
          <style>
        ...
        <body>
          ...
          <div>${answer}</div>
          <div class="footer">This answer was AI-generated by Firm Law AI. Always verify with official sources before use in exams or court.</div>
